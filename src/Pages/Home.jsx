...
const WORDS = ["AI & PROJECT Developer", "AI ENGINEER"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Yadu0" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/yadusinghai/" },
  { icon: Instagram, link: "https://www.instagram.com/yadusinghai/?hl=id" }
];
